...
function carregarcategorias()
 {
	...
	$.ajax(
		...
		success: function(response)
		{
			    ...
			    $("#categorias").empty().load('http://netsolutionmogi.com/php/categorias.php');
				recuperarmesa();
	           recuperarcomanda();
			   contar();
			 somar();
   ...
   $(document).on('click', '#botaocategoria', function(e)
   {
	   ...
	   //window.location.href = url;
           ...
           $.ajax({
			   type: "GET",
				dataType: "html",
				url: "http://netsolutionmogi.com/php/gerarcodigocategorias.php",
				data: dados,
				 success: function (response) 
				 {
