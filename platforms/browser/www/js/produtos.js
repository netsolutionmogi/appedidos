...
function recuperarcodigocategorias()
 {
	 ...
	 $.ajax({
	  url: "http://netsolutionmogi.com/php/recuperacodigocategorias.php",
	   type: "GET",
		dataType: "html",
	...
	$.ajax(
		...
		success: function(response)
		{
			...
			var codigo = $("input[id*='CodigoCategoria']").val();
			    ...
			    $("#produtos").empty().fadeTo('slow',0.8).fadeIn('slow').load('http://netsolutionmogi.com/php/produtos.php?codigo='+ codigo);
		...
		$("#alterar_quantidade #sucesso").hide();
		 ...
		 $('#botaomenos').on('click',function(e)
		 {
		  ...
		  $('#btn_salvar').on('click', function (e)
		  {
			 ...
			 $.ajax({
              url:"http://netsolutionmogi.com/php/atualizar_pedido.php",
               type:"POST",
				dataType:"html",
				async: false,
		     	cache:false,
 ...
 $(document).on('click', '#pedir', function(e)
   {
	   e.preventDefault();
        ...
        url: "http://netsolutionmogi.com/php/adicionar_carrinho.php",
        data: parametros,
		dataType:"html",
   ...
   function contar()
	{
	  $.ajax({
        url: "http://netsolutionmogi.com/php/contar.php",
         type: "GET",
         dataType: "html",
		...
		swal({
			...
			preConfirm: function() {
			  return new Promise(function(resolve) {
			     ...
			     $.ajax({
			   		url: 'http://netsolutionmogi.com/php/delete.php',
			    	type: 'POST',
			       	data: 'delete='+codigo,
			       	dataType: 'json'
			     })
